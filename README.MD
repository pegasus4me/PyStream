...
cd into the smart contracts repo `pay-streams-main` , and install the necessary dependencies
...
# for the interface
cd into the smart contracts repo `paystream-interface-main` , and install the necessary dependencies
